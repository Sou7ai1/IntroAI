...
def grid_2D_tests():
    ...
    informed_search_test(Grid2D(3240,0.8), grid_2D_heuristic, (1,2), (21,26), 44)
    informed_search_test(Grid2D(2235,0.7), grid_2D_heuristic, (-5,3), (112,147), 261)
    informed_search_test(Grid2D(1439,0.6), grid_2D_heuristic, (-674,-341), (284,148), 1605)
...
def grid_diagonal_2D_tests():
    ...
    informed_search_test(GridDiagonal2D(16424,0.8), grid_diagonal_2D_heuristic, (1,2), (21,26), 29)
    informed_search_test(GridDiagonal2D(1234,0.7), grid_diagonal_2D_heuristic, (-5,3), (112,147), 166)
    informed_search_test(GridDiagonal2D(93542,0.5), grid_diagonal_2D_heuristic, (-574,-641), (784,448), 1426)
...
def grid_knight_2D_tests():
    ...
    informed_search_test(GridKnight2D(1234,0.7), grid_knight_2D_heuristic, (-5,3), (112,147), 87)
    informed_search_test(GridKnight2D(45645,0.4), grid_knight_2D_heuristic, (-248,-398), (147,145), 424)
...
def grid_3D_tests():
    ...
    informed_search_test(Grid3D(54236,0.5), grid_3D_heuristic, (50,-12,34), (-5,24,65), 198)
    informed_search_test(Grid3D(9748,0.5), grid_3D_heuristic, (124,353,-124), (145,200,-234), 330)
...
def grid_face_diagonal_3D_tests():
    ...
    informed_search_test(GridFaceDiagonal3D(54236,0.5), grid_face_diagonal_3D_heuristic, (50,-12,34), (-5,24,65), 69)
    informed_search_test(GridFaceDiagonal3D(4348,0.7), grid_face_diagonal_3D_heuristic, (124,-245,-657), (-354,124,-416), 544)
    informed_search_test(GridFaceDiagonal3D(4348,0.2), grid_face_diagonal_3D_heuristic, (174,253,-224), (245,200,-284), 115)
...
def grid_all_diagonal_3D_tests():
    ...
    informed_search_test(GridAllDiagonal3D(43547,0.7), grid_all_diagonal_3D_heuristic, (124,-145,-257), (-154,124,-316), 278)
    informed_search_test(GridAllDiagonal3D(4348,0.1), grid_all_diagonal_3D_heuristic, (224,253,-224), (245,200,-284), 145)
