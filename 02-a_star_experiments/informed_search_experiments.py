...
"""
To run all experiments, run the command
$ python3 informed_search_experiments.py

To run an experiment NAME, run the command
$ python3 informed_search_experiments.py NAME
"""
