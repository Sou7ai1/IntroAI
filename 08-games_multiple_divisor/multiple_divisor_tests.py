...
def main():
    ...
    tests = {
            "trivial": (test_cases_trivial, 2, 0.01),
            "small": (test_cases_small, 2, 0.01),
            "medium": (test_cases_medium, 3, 0.01),
            "large": (test_cases_large, 3, 0.01),
            "challenge": (test_cases_challenge, 3, 3.3),
    }
